        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('SchoolX Teacher', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
              const Text('Sign in to manage your classes', style: TextStyle(color: Colors.grey)),
